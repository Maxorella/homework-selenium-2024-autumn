...
class TestSettings(BaseCaseVkAd):
    ...
    @allure.title('Personal account. Click on the button in the "Settings" menu, a window with settings opens.')
    ...
    @allure.title('Settings. General. Checking the display. ')
    ...
    @allure.title('Settings. Notifications. Checking display.')
    ...
    @allure.title('Settings. Access rights. Display check. "Add office" button.')
    ...
    @allure.title('Settings. History of changes. Checking display. "Filter" button, search field.')
